...
### 🙋‍♀️ About Me
* 📊 **Data Analyst** specializing in data modeling, exploratory analysis, and building business dashboard solutions.
* 🛠️ Proficient in **Python, SQL, Power BI, Tableau, Excel, Pandas, NumPy, and DAX**.
* 💡 Experienced in end-to-end data pipelines—from cleaning messy datasets to creating executive KPI reports.
* 🎯 Focused on translating complex analytics into clear strategic decisions.
...
**Core Domain Skills**  
`Exploratory Data Analysis (EDA)` • `Data Modeling` • `ETL Pipelines` • `KPI Tracking` • `Data Storytelling` • `A/B Testing`
